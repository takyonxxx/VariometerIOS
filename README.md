...
- **Görev zamanlaması (lokal saat / UTC dönüşümü)** — Start time ve deadline değerleri DatePicker'da **telefonun lokal saatinde** gösterilir ve **lokal olarak yorumlanır**. Pilot "13:00" yazarsa telefon lokal saati 13:00 olduğunda start tetiklenir. Dahili Date saklaması UTC'dir (Swift Date her zaman absolute) — `Date()` karşılaştırması da UTC, bu yüzden saat dilimi geçişlerinde tutarsızlık olmaz. **QR'a yazılan değer her zaman UTC `HH:MM:SSZ`** (XCTrack v2 spec gereği): pilot lokal 13:00'i seçti, Türkiye (UTC+3) ise QR'da "10:00:00Z" yazar. Briefing'te "start 13:00 UTC" deniyorsa pilot UI'a 16:00 (lokal) girmelidir; QR yine 13:00:00Z yazar.
